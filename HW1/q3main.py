...
toc = time.perf_counter()
print(f"\nTotal time to calculate number of mail types and probability of choosing a spam or normal mail out of the dataset is {toc - tic:0.4f} seconds")
...
toc = time.perf_counter()
print(f"\nTotal time to find the number of times a word occurs and the count a word occuring in the training datasets is {toc - tic:0.4f} seconds")
